...
public class Play extends GameState {
	...
	/**
	 * Sets up the tile map collidable tiles. Reads in tile map layers and sets up box2d bodies.
	 */
	...
	/**
	 * Creates box2d bodies for all non-null tiles in the specified layer and assigns the specified category bits.
	 * 
	 * @param layer
	...
	private void createCrystals() {
		...
		MapLayer ml = tileMap.getLayers().get("Relecs");
		if (ml == null)
			return;
		...
		for (MapObject mo : ml.getObjects()) {
			...
			body.createFixture(cfdef).setUserData("Relecs");
